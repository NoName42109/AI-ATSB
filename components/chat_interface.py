...
def render_chat_interface():
    ...
    # Chat container
    st.markdown('<div class="chat-messages" style="height: 500px; overflow-y: auto; padding: 20px; background: rgba(0,0,0,0.3); border-radius: 15px; margin-bottom: 20px; border: 1px solid rgba(255,255,255,0.1);">', unsafe_allow_html=True)
